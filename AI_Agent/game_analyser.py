...
from AI_Agent.interface_to_llm import InterfaceToLlm
...
class GameAnalyser:
    ...
    def _preprocess_state(self, state: Dict[str, Any]) -> None:
        ...
        for obj in state.get("objects", []):
            ...
            player_name = str(obj.get("player_name", ""))
            if player_name.lower() in ("civilian", "neutral", "none","team"):
